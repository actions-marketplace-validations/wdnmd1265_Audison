...
<p align="center">
  <strong>AI wrote your code. Audison finds the bugs your AI reviewer missed.</strong>
</p>

---

## Your AI reviewer has blindspots. Audison catches them.
...
Same AI-generated auth code, three reviewers:

| What they found | Standard AI Review | CodeQL / SAST | Audison |
|---|---|---|---|
| SQL injection in login | ❌ Missed | ❌ Missed | 🔴 Found |
| Hardcoded JWT secret | ⚠️ Warning | ❌ Missed | 🔴 Found |
| Missing rate limiting | ❌ Missed | ❌ Missed | 🟡 Found |
| CSRF token bypass | ❌ Missed | ❌ Missed | 🔴 Found |

> One model says "looks fine." A second model disagrees. Audison makes them argue — and you get the bugs neither would find alone.
...
```bash
# 30 seconds, no API key required
npx audison-demo
```

🌐 **Or try in your browser**: [wdnmd1265.github.io/Audison/playground.html](https://wdnmd1265.github.io/Audison/playground.html) — no install, no API key
...
Not sure which models to pair? Use **[Compass](https://github.com/yourusername/compass)** to predict pairing gains before spending on API calls.
...
Compass analyzes Signal Detection Theory parameters (d', c) to predict complementarity gains. Use it to:
...
→ [Full TrustEngine documentation](skills/trust-engine/SKILL.md)
...
│   │   └── conscience.py        # Self-evaluation pipeline
│   ├── brains/
...
│   │   └── brain_blind.py       # Blind review brain: context-free final review
│   ├── core/
